...
function fire_scripts() {
	...
	wp_enqueue_script( 'fire-js', get_template_directory_uri() . '/dist/scripts.js', array(), '20151215', true );
 ...
 * Load menu changes
 */
require get_template_directory() . '/inc/fire-menu.php';
...
/**
 * Load ACF layouts files
 */
require get_template_directory() . '/inc/acf-layout.php';

/**
 * Content changes
 */
require get_template_directory() . '/inc/fire-content.php';

/**
 * Site Admin
 */
require get_template_directory() . '/inc/fire-admin.php';

/**
 * Custom WYSIWYG Styles
 */
require get_template_directory() . '/inc/fire-wysiwyg.php';

/**
 * Section functions
 */
require get_template_directory() . '/inc/fire-section.php';
