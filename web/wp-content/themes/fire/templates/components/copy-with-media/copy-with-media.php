...
<?php $section->start(); ?>
  ...
  <div class="container block md:flex <?php echo $image_position === 'right' ? '' : ' flex-row-reverse ';?> ">
    <div class="flex-shrink-0 w-full md:w-1/2 py-8 md:py-16 text-white <?php echo $image_position === 'right' ? ' md:pr-16 ' : ' md:pl-16 ';?>" <?php echo $image_position === 'right' ? "data-aos='fade-right'" : "data-aos='fade-left'" ;?>>
      <?php echo $copy; ?>
    </div>
